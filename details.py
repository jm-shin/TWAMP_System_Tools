...
if __name__ == '__main__':
    ...
    df = pd.read_csv('C:/Users/82103/Desktop/result/20210217_DETAILS.txt', encoding='utf-8-sig', low_memory=False)
    ...
    # 최종데이터를 csv 파일로 내보내기
    final_data.to_csv('C:/Users/82103/Desktop/result/merge_final.csv', float_format='%.3f', encoding='utf-8-sig')
