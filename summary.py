...
if __name__ == "__main__":
    ...
    summary_df = pd.read_csv(summary_path, encoding='utf-8-sig', low_memory=False)
    details_df = pd.read_csv(details_path, encoding='utf-8-sig', low_memory=False)
    ...
    select_data = merged_data[['area_nm', 'nw_cd', 'nw_dm_dtti', 'cust_id', 'dm_type', 'targ_tp_cd', 'nw_problem', 'device_problem',
    ...
    DataFrame(select_data).to_csv('C:/Users/82103/Desktop/result/summary_result.csv', encoding='utf-8-sig')